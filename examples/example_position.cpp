...
int main(int argc, char * argv[])
{
  ...
  point.velocities[0] = 1.0;  // constant speed
  ...
  point2.velocities[0] = 1.0;  // constant speed
  ...
  point3.velocities[0] = 1.0;  // constant speed
  ...
  point4.velocities[0] = 1.0;  // constant speed
